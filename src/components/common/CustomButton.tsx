...
const variantClasses: Record<NonNullable<CustomButtonProps["variant"]>, string> =
  {
    primary:
      "bg-brand-black text-brand-white rounded-xl font-bold shadow-lg shadow-black/10 hover:bg-brand-black/90",
    secondary:
    ...
    wine: "bg-brand-wine text-brand-white rounded-lg font-bold hover:bg-brand-wine/90",
...
const interactionClasses: Record<
  NonNullable<CustomButtonProps["size"]>,
  string
> = {
  sm: "hover:scale-[1.05] active:scale-95 transition-all cursor-pointer",
