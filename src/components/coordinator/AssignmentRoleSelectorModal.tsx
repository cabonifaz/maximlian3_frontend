...
import type { AssignmentCandidate, AssignmentRole } from "@maximilian/shared/types/assignment.type";

interface AssignmentRoleSelectorModalProps {
  isOpen: boolean;
  role: AssignmentRole;
...
export function AssignmentRoleSelectorModal({
  ...
  onClose,
  onSelect,
}: AssignmentRoleSelectorModalProps) {
