...
interface UserModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (datosUsuario: UserFormData, reset: () => void) => void;
  modo: "crear" | "editar";
  datosIniciales?: UserFormData | null;
  isSubmitting?: boolean;
}

type Tab = "info" | "roles";

const valoresPorDefecto: UserFormData = {
  firstName: "",
  paternalLastName: "",
  maternalLastName: "",
  usuarioCreacion: "",
...
export function UserModal({
  ...
  }, [esModoEdicion, firstName, paternalLastName, setValue]);
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="Nombre"
                    className={`w-full rounded-lg border bg-brand-white px-4 py-2 text-sm outline-none transition-all focus:border-brand-wine focus:ring-2 focus:ring-brand-wine/20 ${errors.firstName ? "border-red-500" : "border-gray-200"}`}
                  />
                  {errors.firstName && (
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border bg-brand-white px-4 py-2 text-sm outline-none transition-all focus:border-brand-wine focus:ring-2 focus:ring-brand-wine/20 ${errors.paternalLastName ? "border-red-500" : "border-gray-200"}`}
                  />
                  {errors.paternalLastName && (
                    <p className="text-xs text-red-500">{errors.paternalLastName.message}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border bg-brand-white px-4 py-2 text-sm outline-none transition-all focus:border-brand-wine focus:ring-2 focus:ring-brand-wine/20 ${errors.maternalLastName ? "border-red-500" : "border-gray-200"}`}
                  />
                  {errors.maternalLastName && (
                    <p className="text-xs text-red-500">{errors.maternalLastName.message}</p>
                  )}
                </div>
              ...
              >
                ...
                {isTranslatorSelected && (
                  <div className="space-y-4 border-l border-gray-100 pl-12 animate-in fade-in slide-in-from-left-4 duration-300">
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        {languagesData?.map((language) => (
                          <div
                            ...
                            className="group flex cursor-pointer items-center gap-3"
                            onClick={() =>
                              handleToggle("languages", language.num1!, selectedLanguages)
                            }
                          >
                            <div
                              className={`flex h-5 w-5 items-center justify-center rounded border transition-all ${
                    ...
                    {errors.languages && (
                      <p className="mt-2 text-xs text-red-500">{errors.languages.message}</p>
                    )}
                  </div>
                )}
              </div>
