...
function normalizarFilaInforme(fila: unknown): InformeListEntry {
  ...
  return {
    ...
    codigoPedido: obtenerTexto(registro.codigoPedido, registro.CodigoPedido),
  ...
  calcularBalance: async (payload: {
    ...
    if (clave === "turquia") {
      const valor = (campo: string) =>
        n(obtenerValorCampoEstadoFinanciero(r, campo, payload.tipoEstadoFinanciero));
      const cuerpo = {
        efectivo: valor("efectivo"),
        existencias: valor("existencias"),
        deudores: valor("deudores"),
        bienesTongibles: valor("bienesTongibles"),
        activosIntangibles: valor("activosIntangibles"),
        prestamos: valor("prestamos"),
        acreedores: valor("acreedores"),
        pasivosNoCorrientes: valor("pasivosNoCorrientes"),
        pasivosLargoPlazo: valor("pasivosLargoPlazo"),
        patrimonio: valor("totalPatrimonio"),
        reservas: valor("reservas"),
        resultadosAcumulados: valor("resultadosAcumulados"),
        perdidaGanancias: valor("resultadoEjercicio"),
        otrasCuentas: valor("otrasCuentas"),
        ventasNetas: valor("ventasNetas"),
        costoVentas: valor("costoVentas"),
        otrosGastosOperativos: valor("otrosGastosOperativos"),
        costoEmpleados: valor("costoEmpleados"),
        depreciacion: valor("depreciacion"),
        ingresosFinancieros: valor("ingresosFinancieros"),
        gastosFinancieros: valor("gastosFinancieros"),
        ingresosExtraordinarios: valor("ingresosExtraordinarios"),
        gastosExtraordinarios: valor("gastosExtraordinarios"),
        impuestos: valor("impuestos"),
        costoMateriales: valor("costoMateriales"),
        interesesPagados: valor("interesesPagados"),
