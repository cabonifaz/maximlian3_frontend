  ...
  balances.forEach((balance, index) => {
    ...
    if (tipo === 1) {
      ...
      lstBalancesTurquia.push({
        ...
        patrimonio: numeroTurquia("patrimonio"),
...
export function construirPayloadCrearInforme({
  ...
  return depurarPayloadInforme({
    ...
    idClasificacion: Number(identificacion.idCalificacion) || 0,
    idExperienciaPago: Number(identificacion.idRecordPagos) || 0,
    idEstadoInforme,
    datosAdicionales: "",
    observacionesIdentificacion: identificacion.datosAdicionales,
    ...
    competidores: operacionPrincipal.competidores,
    ...
    lstProveedores: datosInvestigacion.proveedores.map((proveedor) => ({
      ...
      idPais: proveedor.idPais ?? obtenerIdPorTexto(opcionesPais, proveedor.pais) ?? 0,
      ...
      idLimiteCredito: proveedor.idLimiteCredito ?? 0,
      idTiempoCredito: proveedor.idTiempoCredito ?? 0,
      ...
      idCalificacion: proveedor.idCalificacion ?? 0,
