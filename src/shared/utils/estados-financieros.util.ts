...
const configuracionEstadosFinancieros: Record<string, SeccionEstadoFinancieroAnalista[]> = {
  desagregado: [
    ...
    },
    {
      ...
      titulo: "Ratios",
      campos: [
        { id: "liquidity-ratio", etiqueta: "Ratio de Liquidez" },
        { id: "working-capital-ratio", etiqueta: "Ratio de Capital de Trabajo" },
        { id: "current-indebtedness-ratio", etiqueta: "Ratio de Endeudamiento Corriente" },
        { id: "profitability-ratio", etiqueta: "Ratio de Rentabilidad" },
      ],
    },
  ],
  totalizado: [
    ...
    },
    {
      ...
      titulo: "Ratios",
      campos: [
        { id: "liquidity-ratio-totalizado", etiqueta: "Ratio de Liquidez" },
        { id: "working-capital-ratio-totalizado", etiqueta: "Ratio de Capital de Trabajo" },
        { id: "current-indebtedness-ratio-totalizado", etiqueta: "Ratio de Endeudamiento Corriente" },
        { id: "profitability-ratio-totalizado", etiqueta: "Ratio de Rentabilidad" },
      ],
    },
  ],
  bancos: [
  ...
  turquia: [
    ...
    },
    {
      ...
      campos: [
        ...
        { id: "reserves", etiqueta: "Reservas (Reserves)" },
        { id: "retained-earnings", etiqueta: "Resultados Acumulados (Retained Earnings)" },
        { id: "profit-loss-for-year", etiqueta: "Resultado del Ejercicio (Profit and Loss for Year)", tipoEntrada: "numero" },
        { id: "other-accounts", etiqueta: "Otras Cuentas (Other Accounts)" },
    ...
    },
    {
      ...
      titulo: "Ratios",
      campos: [
        { id: "liquidity-index", etiqueta: "Ratio de Liquidez" },
        { id: "working-capital", etiqueta: "Ratio de Capital de Trabajo" },
        { id: "indebtedness-ratio", etiqueta: "Ratio de Endeudamiento Corriente" },
        { id: "profitability-ratio-turquia", etiqueta: "Ratio de Rentabilidad" },
      ],
    },
  ],
};
...
const aliasCamposEstadoFinanciero: Record<string, Record<string, string>> = {
  ...
  turquia: {
    ...
    reservas: "reserves",
    resultadosAcumulados: "retained-earnings",
    resultadoEjercicio: "profit-loss-for-year",
    otrasCuentas: "other-accounts",
