...
export const RETARDO_CIERRE_SUBMENU_ACCIONES_FACTURA_MS = 250;
...
export const ID_TIPO_OPERACION_SUNAT_EXPORTACION_BIENES = 4;
export const ID_TIPO_OPERACION_SUNAT_EXPORTACION_SERVICIOS = 5;
export const IDS_TIPO_OPERACION_SUNAT_EXPORTACION = [
  ID_TIPO_OPERACION_SUNAT_EXPORTACION_BIENES,
...
export const PLAZO_MAXIMO_DIAS_ANULACION_FACTURA = 7;
export const NUM_MENSAJE_ADVERTENCIA_ANULACION_MANUAL = 1;
export const NUM_MENSAJE_CONFIRMACION_ANULACION_MANUAL = 2;
