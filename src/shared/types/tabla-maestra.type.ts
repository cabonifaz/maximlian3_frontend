export const TablaMaestraId = {
  ...
  MONEDA: 12,
  TIPO_CONTACTO: 14,
  TIPO_DOCUMENTO_INVESTIGACION: 25,
  CALIFICACION_PROVEEDOR: 26,
  AREA_TRABAJO: 35,
  ESTADO_ACTUAL: 7,
  ESTADO_CLIENTE: 36,
  PRODUCTO: 37,
  ...
  ESTADO_DOCUMENTO_ELECTRONICO: 77,
  TIPO_NOTA_CREDITO_DEBITO: 78,
  SUNAT_MOTIVO_NOTA_CREDITO: 79,
  SUNAT_MOTIVO_NOTA_DEBITO: 80,
  MENSAJE_ANULACION_MANUAL_FACTURA: 81,
  VIGENCIA_PEDIDOS: 82,
  CALIFICACION: 83,
  RECORD_PAGOS: 84,
...
const descripcionesTablaMaestraPorId: Partial<Record<TablaMaestraId, string>> =
  {
    ...
    [TablaMaestraId.TIPO_DOCUMENTO_INVESTIGACION]: "TIPO DOCUMENTO",
    [TablaMaestraId.AREA_TRABAJO]: "AREA TRABAJO",
    [TablaMaestraId.ESTADO_ACTUAL]: "ESTADO ACTUAL",
    ...
    [TablaMaestraId.AFECTACION_IGV_SUNAT]: "SUNAT AFECTACION IGV",
    [TablaMaestraId.TIPO_NOTA_CREDITO_DEBITO]: "TIPO NOTA CREDITO DEBITO",
    [TablaMaestraId.SUNAT_MOTIVO_NOTA_CREDITO]: "SUNAT MOTIVO NOTA CREDITO",
    [TablaMaestraId.SUNAT_MOTIVO_NOTA_DEBITO]: "SUNAT MOTIVO NOTA DEBITO",
    [TablaMaestraId.MENSAJE_ANULACION_MANUAL_FACTURA]: "MENSAJE ETIQUETA",
    [TablaMaestraId.VIGENCIA_PEDIDOS]: "VIGENCIA PEDIDOS",
